        ...
        <div class="card">
            <div
                ...
                <h4><i class="fa fa-bell" aria-hidden="true"></i>
                    <span class="ml-2">Add - Alert</span>
                </h4>
            </div>
            <hr class="mt-0">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="text" maxlength="64" onkeypress="return /[0-9a-zA-Z\s]/i.test(event.key)"
                                       class="form-control" name="alert_name" placeholder="Name" required>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" maxlength="64" class="form-control" name="alert_description"
