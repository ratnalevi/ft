...
@section('content')
            ...
            <div class="row m-3">
                ...
                <div class="col-lg-3 mt-3">
                    <input style="height: 49px !important; margin: 0px 25px 0px 0px; border-radius: 36px;"
                           id="fromdate" type="datetime-local" class="form-control" value="{{ $newEndDate }}"
                ...
                <div class="table-container">
                    <table id="myTable" class="table tableFixHead">
                        ...
                        <tr>
                            ...
                            {{--                            <th style="text-align: center;" class="sort">POS Pints</th>--}}
                            <th style="text-align: center;" class="sort">POS OZ</th>
                            <th style="text-align: center;" class="sort">Net Amt</th>
                            {{--                            <th style="text-align: center;" class="sort">FT Pints</th>--}}
                            <th style="text-align: center;" class="sort">FT OZ</th>
                            <th style="text-align: center;" class="sort">FT Amt</th>
                            <th style="text-align: center;" class="sort">PourScore (OZ)</th>
                            <th style="text-align: center;" class="sort">PourScore ($)</th>
                        </tr>
                        </thead>
                        <tbody id="tbodyid"></tbody>
                        <tfoot id="footer-total-row"></tfoot>
                    </table>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        function loadData() {
            ...
            $.ajax({
                url: "{{ url('/pour-score-detail-data/') }}/" + device + "/" + fromdate + "/" + todate,
                type: 'GET',
                dataType: 'json',
                success: function (dataList) {
                    $("#tbodyid").empty();
                    ...
                    dataList.result.forEach((item => {
                        const row = "<tr>" +
                            ...
                            // "<td style='text-align:center;'>" + item['POS Pints'] + "</td>" +
                            "<td style='text-align:center;'>" + item['POS OZ'] + "</td>" +
                            "<td style='text-align:center;'>$" + item['POS NET'] + "</td>" +
                            // "<td style='text-align:center;'>" + item['FT Pints'] + "</td>" +
                            "<td style='text-align:center;'>" + item['FT OZ'] + "</td>" +
                            "<td style='text-align:center;'>$" + item['Exp Amt'] + "</td>" +
                            "<td style='text-align:center;'>" + item['PourScore'] + "%</td>" +
                            "<td style='text-align:center;'>" + item['PourScore - $'] + "%</td>" +
                            "</tr>";
