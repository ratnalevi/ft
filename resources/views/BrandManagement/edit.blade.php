        ...
        <div class="card">
            <div class="m-3">
                ...
                <h5>
                    ...
                    <span class="ml-3">Edit - Brand</span>
                </h5>
            </div>
            ...
            <form method="post" action="/save/brand" class="m-3">
                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <input id="brandName" minlength="6" maxlength="128" type="text" class="form-control"
                                       name="brand_name" value="{{ $beertypes1->Brand }}"
                                       onkeypress="return /[0-9a-zA-Z\s]/i.test(event.key)">
                                <input type="text" class="form-control" hidden name="brand_id"
                                       value="{{ $beertypes1->BeerBrandsID }}" required>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <input type="text" id="abv" class="form-control" name="abv"
                                       value="{{ $beertypes1->ABV }}" required>
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <input type="text" id="comments" class="form-control" minlength="6" maxlength="128"
                                       value="{{ $beertypes1->Comments }}" name="comments" required>
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <select class="form-control locationLOca" name="beer_type_id" id="beer_type_id"
                                    ...
                                    @foreach ($beertypes as $items)
                                        @if ($items->BeerTypeID === $beertypes1->BeerTypeID)
                                            <option selected value="{{ $items->BeerTypeID }}">{{ $items->Description }}
                                            </option>
                                        @else
                ...
                <div class="m-1">
                    <div class="row">
                        ...
                        <div class="col-lg-2">
                            <div class="form-group">
                                <input type="submit" id="submit" class="btn btn-secondary ml-4 mr-4" value="Update">
                            </div>
                        </div>
